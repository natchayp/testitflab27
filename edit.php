...
<html>
    ...
    <body>
        ...
        <nav class="navbar navbar-expand-lg navbar-light fixed-top" id="mainNav">
          ...
          <br>
        <div class="container">
            <h1 class="display-1">TEST LAB Database Update</h1>
        </div>
        ...
        <div class="container">
            <form action = "update.php" method = "post" id="CommentForm" >
                ...
                <div class="form-group">
                    ...
                    <input type="number" class="form-control" name = "weight" id="idLink" placeholder="Enter your weight" value=<?php echo $link;?>>
                  </div>
